    ...
    useEffect(() => {
        ...
        async function fetchMovies() {
            try {
                setIsLoading(true);
                setError("");
                const res = await fetch(`https://www.omdbapi.com/?tt3896198&apikey=${KEY}&s=${query}`, {signal: controller.signal});
    ...
    useEffect(() => {
        async function getMovieDetails() {
            ...
            const res = await fetch(
                `https://www.omdbapi.com/?tt3896198&apikey=${KEY}&i=${selectedId}`);
